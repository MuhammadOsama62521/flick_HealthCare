...
<Form>
    ...
    <Form.Control name="newquantity" onChange={this.handleCh} placeholder="0" />
</Form.Group>
    </Form.Row>
    <Form.Row>
    <Form.Group as={Col}  controlId="formGridquantity">
    <Form.Label>Price</Form.Label>
    <Form.Control name="uprice" onChange={this.handleCh} placeholder="$" />
</Form.Group>
    </Form.Row>
</Form>
...
<hr/>
  ...
  <Form.Group as={Col} controlId="formGridname">
      ...
      <Form.Control name="customer" onChange={this.handleCh} type="text" placeholder="Full Name" />
    </Form.Group>

    <Form.Group as={Col} controlId="formGridname">
      <Form.Label>Consult Person</Form.Label>
      <Form.Control name="consult_person" onChange={this.handleCh} type="text" placeholder="Full Name" />
    </Form.Group>
    </Form.Row>
...
<Form.Group as={Col} controlId="formGridAddress1">
    ...
    <Form.Control name="address" onChange={this.handleCh} placeholder="Street/No Block etc" />
</Form.Group>
...
<Form.Group as={Col} controlId="formGridreturn1">
    ...
    <Form.Control name="invoice_id" onChange={this.handleCh} placeholder="Invoice id without FL205-" />
</Form.Group>
...
<Form.Group as={Col} controlId="formGridreturn2">
    ...
    <Form.Control name="qreturn" onChange={this.handleCh} placeholder="0" />
</Form.Group>

<Form.Group as={Col} controlId="formGridreturn2">
    <Form.Label>Amount Returned</Form.Label>
    <Form.Control name="areturn" onChange={this.handleCh} placeholder="$" />
</Form.Group>
</Form.Row>
</Form>
...
<Form>
    ...
    <Form.Control name="statusid" onChange={this.handleCh} placeholder="Invoice id without FL205-" />
</Form.Group>
    </Form.Row>
</Form>
<Button
